...
const Footer = () => {
  ...
  return (
    <div className="bg-black text-white">
      <div className="px-8 md:px-16 lg:px-24 xl:px-48 pt-16 pb-12">
        <SocialIcon />
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 gap-x-12 mt-[37px] md:mt-[80px] mb-[61px] md:mb-[135px]">
          {footerLinks.map((link, index) => (
            <Link href={link.href} key={index}>
              <span className="font-semibold text-xs md:text-xl xl:text-2xl whitespace-nowrap">
                {link.label}
              </span>
            </Link>
          ))}
